...
%changelog
* Sun Feb 18 2024 Damian Ludwig <ludwigd@fedoraproject.org>
- fix: too may args for clear_all_inhibitors (ludwigd@fedoraproject.org)
- fix: update README.org (ludwigd@fedoraproject.org)
